...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="/admin-area" class="a-breadcrumbs">Beranda</a> / <a href="/admin-area/dokter"
        class="a-breadcrumbs">Data Dokter</a> / </span> Dokter Edit</h4>
    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="id_dokter" readonly class="form-control" placeholder="ID Dokter" value="{{ old('id_dokter', $dokter[0] -> id_dokter) }}" required>
                                    @error('id_dokter')
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_dokter" class="form-control" placeholder="Nama Dokter" value="{{ old('nama_dokter', $dokter[0] -> nama_dokter) }}" required>
                                    @error('nama_dokter')
                                    <div id="defaultFormControlHelp" class="form-text bg-warning text-black">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="no_hp_dokter" class="form-control" placeholder="No Telepon" value="{{ old('no_hp_dokter', $dokter[0] -> no_hp_dokter) }}" required>
                                    @error('no_hp_dokter')
                                    <div id="defaultFormControlHelp" class="form-text bg-warning text-black">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="email_dokter" class="form-control" placeholder="Email Dokter" value="{{ old('email_dokter', $dokter[0] -> email_dokter) }}" required>
                                    @error('email_dokter')
                                    <div id="defaultFormControlHelp" class="form-text bg-warning text-black">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="jadwal_dokter" class="form-control" placeholder="Jadwal Dokter" value="{{ old('jadwal_dokter', $dokter[0] -> jadwal_dokter) }}" required>
                                    @error('jadwal_dokter')
                                    <div id="defaultFormControlHelp" class="form-text bg-warning text-black">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="card-body">
                                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                                        <img src="{{ asset('/img/dokter/'.$dokter[0] -> images) }}" alt="user-avatar" class="d-block rounded"
